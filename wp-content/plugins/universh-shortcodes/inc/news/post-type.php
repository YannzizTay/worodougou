<?php
if ( ! function_exists('universh_news_post_type') ) {

// Register Custom Post Type
function universh_news_post_type() {

	$labels = array(
		'name'                => _x( 'News', 'Post Type General Name', 'universh' ),
		'singular_name'       => _x( 'News', 'Post Type Singular Name', 'universh' ),
		'menu_name'           => __( 'News', 'universh' ),
...
add_action( 'init', 'universh_news_post_type', 0 );

}

if ( ! function_exists( 'universh_news_category_taxonomy' ) ) {

// Register Custom Taxonomy
function universh_news_category_taxonomy() {
...
// Hook into the 'init' action
add_action( 'init', 'universh_news_category_taxonomy', 0 );
